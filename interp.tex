...
% ═════════════════════════════════════════════════════════════════════════════
\begin{frame}{The ``Locate $\to$ Steer $\to$ Improve'' Pipeline \papertag[UCRnavy]{Paper \textcircled{2}}}
  \vspace*{0.3cm}
  \begin{tikzpicture}[
    ...
    \node[block=UCRnavy, label={[font=\Huge\bfseries\color{UCRnavy},
      ...
      {{\bfseries\color{UCRnavy}\large LOCATE}\\[0.15em]
    ...
    \node[block=UCRnavy, label={[font=\Huge\bfseries\color{UCRnavy},
      ...
      {{\bfseries\color{UCRnavy}\large IMPROVE}\\[0.15em]
...
% ═════════════════════════════════════════════════════════════════════════════
\begin{frame}{Core Interpretable Objects of LLMs \papertag[UCRnavy]{Paper \textcircled{2}}}
...
\begin{frame}{Token Embedding \& Residual Stream}
  ...
  \begin{tikzpicture}
    \foreach \i/\lbl/\col in {
      0/Input Tokens/UCRnavy, 1/Embed ($x^0$)/UCRnavy,
      2/Block 1/UCRnavy, 3/Block $L$/UCRnavy, 4/Output Logits/UCRnavy}
    {
...
\begin{frame}{Sparse Autoencoders: Resolving Superposition}
  \begin{columns}[T]
    ...
    {\small\bfseries\navy{The Problem: Superposition}}\\[0.2em]
...
\begin{frame}{Steering Methods: Intervening on LLM Internals}
  \begin{tcolorbox}[enhanced, colback=UCRlgray, colframe=UCRmgray,
      ...
      fonttitle=\bfseries\small\color{UCRnavy}, title=Amplitude Manipulation,
      top=3pt, bottom=3pt]
    ...
    \hfill\navy{\tiny \textbf{!} fragile if target is polysemantic}
  \end{tcolorbox}
  \vspace{3pt}
  \begin{tcolorbox}[enhanced, colback=UCRlgray, colframe=UCRmgray,
      borderline west={4pt}{0pt}{UCRnavy}, sharp corners,
    ...
    \hfill\navy{\tiny \textbf{!} careful mask selection required}
  \end{tcolorbox}
  \vspace{3pt}
  \begin{tcolorbox}[enhanced, colback=UCRlgray, colframe=UCRmgray,
      borderline west={4pt}{0pt}{UCRnavy}, sharp corners,
      fonttitle=\bfseries\small\color{UCRnavy}, title=Vector Arithmetic,
      top=3pt, bottom=3pt]
    ...
    \hfill\navy{\tiny \textbf{!} linear assumption may break down}
  \end{tcolorbox}
\end{frame}
...
% ═════════════════════════════════════════════════════════════════════════════
\begin{frame}{MI Applications: Improve Alignment \papertag[UCRnavy]{Paper \textcircled{2}}}
  \begin{tcolorbox}[enhanced, colback=UCRlgray, colframe=UCRmgray,
      borderline west={4pt}{0pt}{UCRnavy}, sharp corners,
      fonttitle=\bfseries\small\color{UCRnavy}, title=Safety \& Reliability,
      top=3pt, bottom=3pt]
  ...
  \begin{tcolorbox}[enhanced, colback=UCRlgray, colframe=UCRmgray,
      borderline west={4pt}{0pt}{UCRnavy}, sharp corners,
      fonttitle=\bfseries\small\color{UCRnavy}, title=Fairness \& Bias,
      top=3pt, bottom=3pt]
    \begin{itemize}\footnotesize\setlength\itemsep{2pt}
...
% ═════════════════════════════════════════════════════════════════════════════
\begin{frame}{MI Applications: Capability \& Efficiency \papertag[UCRnavy]{Paper \textcircled{2}}}
  \begin{columns}[T]
    \column{0.48\textwidth}
