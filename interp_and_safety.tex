...
\begin{frame}{Open Challenges at the Interpretability–Safety Interface}
  \begin{columns}[T]
    \column{0.48\textwidth}
    \begin{ucrcard}[UCRnavy]{[!} Interpretation-Based Attacks, top=3pt, bottom=3pt]
      \scriptsize
    ...
    \end{ucrcard}\vspace{3pt}
    \begin{ucrcard}[UCRnavy]{[?} Reliable Evaluation of Interpretations, top=3pt, bottom=3pt]
      \scriptsize
    ...
    \column{0.48\textwidth}
    \begin{ucrcard}[UCRnavy]{[DB} TDA for Safety Enhancement, top=3pt, bottom=3pt]
      \scriptsize
    ...
    \end{ucrcard}\vspace{3pt}
    \begin{ucrcard}[UCRnavy]{[People} User-Centered Presentation, top=3pt, bottom=3pt]
      \scriptsize
    ...
    \end{ucrcard}\vspace{3pt}
    \begin{ucrcard}[UCRnavy]{[Scope} Broader Safety Dimensions, top=3pt, bottom=3pt]
      \scriptsize
