...
\definecolor{UCRnavy}{HTML}{C0272D}
\definecolor{UCRnavy}{HTML}{007B8A}
\definecolor{UCRnavy}{HTML}{6A0572}
\definecolor{UCRnavy}{HTML}{2D6A4F}
\definecolor{UCRnavy}{HTML}{E07B31}
\definecolor{UCRnavy}{HTML}{3A7D44}
\definecolor{UCRnavy}{HTML}{C9A84C}
\definecolor{UCRnavy}{HTML}{4A90D9}
\definecolor{UCRmgray}{HTML}{888888}
\definecolor{UCRlgray}{HTML}{F5F5F5}
\definecolor{UCRdark}{HTML}{333333}
\definecolor{UCRnavy}{HTML}{FDEDED}
...
\newcommand{\redc}[1]{{\color{UCRnavy}#1}}
\newcommand{\tealc}[1]{{\color{UCRnavy}#1}}
\newcommand{\greenc}[1]{{\color{UCRnavy}#1}}
\newcommand{\muted}[1]{{\color{UCRmgray}\itshape#1}}
\newcommand{\orangec}[1]{{\color{UCRnavy}#1}}
\newcommand{\purpc}[1]{{\color{UCRnavy}#1}}
...
\newtcolorbox{ucrwarn}{
  enhanced, sharp corners,
  colback=UCRnavy, colframe=UCRnavy,
  borderline west={3pt}{0pt}{UCRnavy},
  top=3pt, bottom=3pt, left=6pt, right=6pt,
}

\newtcolorbox{ucrinfo}{
  enhanced, sharp corners,
  colback=UCRlgray, colframe=UCRnavy,
  borderline west={3pt}{0pt}{UCRnavy},
  top=3pt, bottom=3pt, left=6pt, right=6pt,
}
...
\newcommand{\sectionframe}[4]{%
  \begin{frame}[plain]
    \begin{tikzpicture}[remember picture, overlay]
      ...
      % Section number
      \node[anchor=north west, text=UCRnavy, font=\Huge\bfseries,
      ...
      % Source line
      \node[anchor=center, text=UCRnavy!80!UCRnavy, font=\small\itshape]
...
\begin{frame}{\S4.2.3\ Editing Harmful Model Components}
  ...
  \begin{columns}[T]
    ...
    \end{tcolorbox}\vspace{2pt}
    \begin{tcolorbox}[enhanced, colback=UCRlgray, colframe=UCRnavy, sharp corners,
        borderline west={3pt}{0pt}{UCRnavy}, fonttitle=\bfseries\scriptsize\color{UCRnavy},
...
\begin{frame}{Open Challenges at the Interpretability–Safety Interface}
  \begin{columns}[T]
    \column{0.48\textwidth}
    \begin{tcolorbox}[enhanced, colback=UCRnavy, colframe=UCRnavy, sharp corners,
